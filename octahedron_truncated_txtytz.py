...
This model provides the form factor, $P(q)$, for an octahedron truncated differently along 3 directions (x,y,z).
...
and  the truncations tx, ty, tz relative to the 3 directions.
...
The model is using length_a and, two ratios b2a_ratio and c2a_ratio and the truncation tx, ty, tz :
